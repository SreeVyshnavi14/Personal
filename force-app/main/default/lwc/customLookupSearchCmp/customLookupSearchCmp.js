...
export default class CustomLookupSearchCmp extends LightningElement {
    ...
    @wire(fetchLookupData, { searchKey: '$searchKey', sObjectApiName: '$sObjectApiName', accRecordId: '$accountrecordid' })
    searchResult(value) {
        //alert(value);
