...
export default class InAppSecondaryFeatureChild extends NavigationMixin(LightningElement) {
    ...
    @api linkReferenceCredential = "";
    @api linkReferenceContract = "";
    @api linkReferenceProvider = "";
    @api app = "";
    @api page = "";
    @api objectName = "";
    @api objectNameCredential = "";
    @api objectCredentialId = "";
    @api objectNameAccount = "";
    @api objectAccountId = "";
    @api objectNameProviderContact = "";
    @api objectProviderContactId = "";
    @api objectNameContract = "";
    @api objectContractId = "";
    ...
    @api secondaryUmTextPresent = false;
    @api secondaryCareRequestText = "";
    @api secondaryCaseTab = "";
    @api noRecord = false;
    @api appText = "";
    @api providerText = "";
    @api providerLink = "";
    ...
    @api pnmTextPresent = false;
    @api pnmText = "";
    @api pnmRecruitmentText = "";
    @api pnmRecruitmentLink = "";
    @api pnmCredentialingText = "";
    @api pnmCredntialingEndText = "";
    @api pnmNetworkText = "";
    @api pnmNetworkEndText = "";
    @api pnmContractText = "";
    @api pnmContractEndText = "";
  ...
  handleClickForCredential(event){
    if (this.linkReferenceCredential == "standard__recordPage") {
          this.pageReference = {
              type: "standard__app",
              attributes: {
                  appTarget: this.app,
                  pageRef: {
                      type: 'standard__recordPage',
                      attributes: {
                          objectApiName: this.objectNameCredential,
                          actionName: 'view',
                          recordId: this.objectCredentialId
                      }
  ...
  handleClickForContract(event){
    if (this.linkReferenceContract == "standard__recordPage") {
          this.pageReference = {
              type: "standard__app",
              attributes: {
                  appTarget: this.app,
                  pageRef: {
                      type: 'standard__recordPage',
                      attributes: {
                          objectApiName: this.objectNameContract,
                          actionName: 'view',
                          recordId: this.objectContractId
                      }
