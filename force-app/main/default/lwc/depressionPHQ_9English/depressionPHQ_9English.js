...
import { OMNIDEF } from './depressionPHQ_9English_def.js';
import tmpl from './depressionPHQ_9English.html';
import tmpl_nds from './depressionPHQ_9English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class depressionPHQ_9English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
