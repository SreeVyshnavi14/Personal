...
import { OMNIDEF } from './behavioralHealthAUDITCEnglish_def.js';
import tmpl from './behavioralHealthAUDITCEnglish.html';
import tmpl_nds from './behavioralHealthAUDITCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class behavioralHealthAUDITCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
