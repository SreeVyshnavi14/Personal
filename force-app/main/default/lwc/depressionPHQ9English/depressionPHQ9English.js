...
import { OMNIDEF } from './depressionPHQ9English_def.js';
import tmpl from './depressionPHQ9English.html';
import tmpl_nds from './depressionPHQ9English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class depressionPHQ9English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
